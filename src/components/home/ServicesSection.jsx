...
const ServicesSection = () => {
  ...
  return (
    <section id="services" ref={sectionRef} className='min-h-screen section-dark-alt text-white relative depth-3 section-transition' style={{ border: 'none', boxShadow: 'none' }}>
